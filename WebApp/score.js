...
(function() {
		...
		DrawBourdNumber(context_01, score);
		
       	//draw numbers
		
		//context.fillText(0,35,15);

		//draw diangle line        
		context_01.moveTo(25,0);
		context_01.lineTo(50,25);
		
		DrawBourd(context_01, score);
		...
		function DrawBourdNumber(context, score) {
			...
			context.fillText(score.frame.num1 ,35,15);
			context.fillText(score.frame.num2 ,35,30);
			context.fillText(score.frame.num3 ,35,45);
